...
/** 
 * Class for Girls of Type : The _choosy.
 */
public class _choosy {
     ...
     * Happiness of a _choosy is logarithmic of the total cost of gifts achieved over maintenance.
     ...
     */
    public _choosy(String crit, String name, int att, int iLevel, int Budget) {
        this.crit = crit;
        this.name = name;
        this.att = att;
        this.iLevel = iLevel;
    ...
    public _couple makeCouple(_miser []mBoys, _generous []genBoys, _geeks []gkBoys, _essentialGift []esGifts, _utilityGift []utGifts, _luxuryGift []lGifts){
        ...
        if(curMBoy != null)
        {
            ...
            curMBoy.chGrlfrnd = _choosy.this;
        ...
        if(curGenBoy != null)
        {
            ...
            curGenBoy.chGrlfrnd = _choosy.this;
        ...
        if(curGkBoy != null)
        {
            ...
            curGkBoy.chGrlfrnd = _choosy.this;
