...
/** 
 * Class for Girls of Type : The _desperate.
 * Superclass: girl.
 */
public class _desperate {
     ...
     */
    public _desperate(String crit, String name, int att, int iLevel, int Budget) {
        this.crit = crit;
        this.name = name;
        this.att = att;
        this.iLevel = iLevel;
    ...
    public _couple makeCouple(_miser []mBoys, _generous []genBoys, _geeks []gkBoys, _essentialGift []esGifts, _utilityGift []utGifts, _luxuryGift []lGifts){
        ...
        if(curMBoy != null)
        {
            ...
            curMBoy.grlType = "The Desperate";
            curMBoy.dsGrlfrnd = _desperate.this;
        ...
        if(curGenBoy != null)
        {
            ...
            curGenBoy.grlType = "The Desperate";
            curGenBoy.dsGrlfrnd = _desperate.this;
        ...
        if(curGkBoy != null)
        {
            ...
            curGkBoy.grlType = "The Desperate";
            curGkBoy.dsGrlfrnd = _desperate.this;
